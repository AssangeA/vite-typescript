...
export declare function createSourceFiles(): {
    ...
    getAll: () => {
        ...
        updateTemplateScript: (templateTsLs: {
            ...
            doComplete: (uri: string, position: vscode.Position, options?: import("typescript/lib/tsserverlibrary").GetCompletionsAtPositionOptions | undefined) => Promise<vscode.CompletionItem[]>;
            ...
            __internal__: {
                ...
                doCompleteSync: (uri: string, position: vscode.Position, options?: import("typescript/lib/tsserverlibrary").GetCompletionsAtPositionOptions | undefined) => vscode.CompletionItem[];
            };
        }) => boolean;
