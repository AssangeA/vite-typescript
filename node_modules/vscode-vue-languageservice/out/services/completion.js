...
function register({ modules: { html, emmet }, sourceFiles, getTsLs, htmlLs, pugLs, getCssLs, jsonLs, documentContext, vueHost, templateTsLs }, getScriptContentVersion) {
        ...
        async function getHtmlResult(sourceFile) {
            ...
            for (const sourceMap of [...sourceFile.getHtmlSourceMaps(), ...sourceFile.getPugSourceMaps()]) {
                ...
                for (const c of contextItems) {
                    const data = c.data;
                    const dir = shared_1.hyphenate(data.name);
                    if (dir.startsWith('v-')) {
                        const key = 'dir:' + dir;
                ...
                for (const [_componentName, { item, bind, on }] of componentCompletion) {
                    ...
                    for (const componentName of componentNames) {
                        ...
                        for (const prop of bind) {
                            ...
                            const name = nameCases.attr === 'camelCase' ? data.name : shared_1.hyphenate(data.name);
    ...
    function useComponentCompletionData(sourceFile) {
        ...
        const projectVersion = reactivity_1.ref();
