...
function register(context) {
    ...
    return async (connection, uri) => {
        ...
        async function getEdits(_sourceFile, _script, _scriptSetup, _scriptAst, _scriptSetupAst) {
            var _a, _b, _c, _d;
            const ranges = scriptSetupConvertRanges_1.parseUnuseScriptSetupRanges(ts, _scriptSetupAst);
            const scriptRanges = _scriptAst ? scriptSetupConvertRanges_2.parseUseScriptSetupRanges(ts, _scriptAst) : undefined;
            const document = _sourceFile.getTextDocument();
            const edits = [];
