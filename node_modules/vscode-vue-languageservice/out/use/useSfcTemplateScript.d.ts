...
export declare function useSfcTemplateScript(getUnreactiveDoc: () => TextDocument, template: Ref<shared.Sfc['template']>, styles: Ref<shared.Sfc['styles']>, templateScriptData: ITemplateScriptData, styleDocuments: Ref<{
